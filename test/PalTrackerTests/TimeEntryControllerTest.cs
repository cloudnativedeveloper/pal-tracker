...
namespace PalTrackerTests
{
    public class TimeEntryControllerTest
    {
        ...
        public void Read_NotFound()
        {
            ...
            _operationCounter.Verify(oc => oc.Increment(TrackedOperation.Read), Times.Never);
        }
        ...
        public void Update_NotFound()
        {
            ...
            Assert.Equal(404, typedResponse.StatusCode);
            _operationCounter.Verify(oc => oc.Increment(TrackedOperation.Update), Times.Never);
        }
        ...
        public void Delete_NotFound()
        {
            ...
            Assert.Equal(404, typedResponse.StatusCode);
            _operationCounter.Verify(oc => oc.Increment(TrackedOperation.Delete), Times.Never);
        }
    }
}